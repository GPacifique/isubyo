    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50 px-4">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">{{ __('messages.your_email_has_been_confirmed') }}</p>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-green-800">
                            {{ __('messages.you_can_now_access_your_account') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">{{ __('messages.what_to_do_next') }}</h2>
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <p class="text-gray-700">{{ __('messages.your_email_is_now_verified') }}</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 mr-3 mt-0.5">
                            <span class="text-sm font-medium text-green-600">2</span>
                        </div>
                        <p class="text-gray-700">{{ __('messages.click_below_to_access_dashboard') }}</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 mr-3 mt-0.5">
                            <span class="text-sm font-medium text-green-600">3</span>
                        </div>
                        <p class="text-gray-700">{{ __('messages.enjoy_full_platform_access') }}</p>
                    </li>
                </ul>
            </div>
            ...
            <div class="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-sm text-blue-900">
                    <span class="font-semibold">{{ __('messages.tip') }}:</span>
                    {{ __('messages.email_verification_tip') }}
                </p>
            </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600 text-sm">
                    ...
                    <a href="{{ route('login') }}" class="text-green-600 hover:text-green-700 font-medium">{{ __('messages.contact_support') }}</a>
                </p>
            </div>
        </div>
    </div>
