...
<div class="min-h-screen flex bg-slate-950">
    ...
    <div class="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center px-16 xl:px-24 w-full">
            ...
            <!-- Elegant Heading -->
            <div class="mb-10">
                <p class="text-emerald-400 font-semibold tracking-wider uppercase text-sm mb-4">Start your journey today</p>
    ...
    <div class="w-full lg:w-[45%] flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-white dark:bg-slate-900">
        <div class="w-full max-w-[420px]">
            ...
            <div class="text-center lg:text-left mb-8">
                <h2 class="text-3xl sm:text-4xl font-bold text-slate-800 dark:text-white mb-3 tracking-tight">Create account</h2>
                <p class="text-slate-500 dark:text-slate-400">Fill in your details to get started</p>
            </div>
