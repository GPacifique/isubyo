...
@section('title', 'Create New Permission - Admin Dashboard')
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white shadow">
        <div class="max-w-4xl mx-auto py-8 px-4">
            ...
            <h1 class="text-4xl font-bold">Create New Permission</h1>
            <p class="text-indigo-100 mt-2">Define a new system permission</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('admin.permissions.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                        ...
                        placeholder="e.g., reports.export" required>
                    <p class="text-xs text-gray-500 mt-1">Use lowercase letters, underscores, and dots (e.g., category.action)</p>
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" id="display_name" name="display_name" value="{{ old('display_name') }}"
                        ...
                        placeholder="e.g., Export Reports" required>
                    @error('display_name')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
