...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Edit Loan Repayment</h1>
            <p class="text-gray-600 mt-2">Loan #{{ $loan->id }} - Payment #{{ $payment->id }}</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.loans.repayments.update', [$loan, $payment]) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        id="principal_paid"
                        name="principal_paid"
                        value="{{ old('principal_paid', $payment->principal_paid) }}"
                        step="0.01"
                        min="0"
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        id="charges_paid"
                        name="charges_paid"
                        value="{{ old('charges_paid', $payment->charges_paid) }}"
                        step="0.01"
                        min="0"
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        id="total_paid"
                        name="total_paid"
                        value="{{ old('total_paid', $payment->total_paid) }}"
                        step="0.01"
                        min="0"
