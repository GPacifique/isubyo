...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Savings History</h1>
                    <p class="text-gray-600 mt-2">{{ $saving->group->name }} - Detailed transaction history</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <p class="text-xs text-gray-500 uppercase font-semibold">Total Deposited</p>
                <p class="text-3xl font-bold text-blue-600 mt-2">{{ number_format($stats['total_deposited'] ?? 0, 0) }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <p class="text-xs text-gray-500 uppercase font-semibold">Total Withdrawn</p>
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            @else
                <div class="px-6 py-12 text-center">
                    <p class="text-gray-500 text-lg">No transactions found for this savings account.</p>
                </div>
            @endif
        </div>
    </div>
