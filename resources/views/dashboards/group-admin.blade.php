...
@section('title', __('messages.group_admin_dashboard') . ' - ' . $group->name)
    ...
    <nav class="bg-white/80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-40">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('group-admin.dashboard') }}" class="flex items-center space-x-3">
                        ...
                        <div class="hidden sm:block">
                            ...
                            <span class="text-xs text-gray-500 block -mt-1">{{ __('messages.group_admin') }}</span>
                        </div>
                    </a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div id="quickActionsMenu" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                            <a href="{{ route('group-admin.record-member-loan', $group) }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-indigo-50 transition">
                                ...
                                <span class="font-medium">{{ __('messages.record_loan') }}</span>
                            </a>
                            <a href="{{ route('group-admin.record-savings', $group) }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-indigo-50 transition">
                                ...
                                <span class="font-medium">{{ __('messages.record_savings') }}</span>
                            </a>
                            <a href="{{ route('group-admin.record-interest', $group) }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-indigo-50 transition">
                                ...
                                <span class="font-medium">{{ __('messages.record_interest') }}</span>
                            </a>
                            ...
                            <a href="{{ route('group-admin.members.create', $group) }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-indigo-50 transition">
                                ...
                                <span class="font-medium">{{ __('messages.add_member') }}</span>
                            </a>
                            <button onclick="showCreateSocialSupportModal()" class="w-full flex items-center px-4 py-3 text-gray-700 hover:bg-indigo-50 transition">
                                ...
                                <span class="font-medium">{{ __('messages.social_support') }}</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div id="ga-switcher-menu" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
                            <div class="px-4 py-3 bg-gradient-to-r from-gray-50 to-gray-100 border-b">
                                <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">{{ __('messages.switch_dashboard') }}</p>
                            </div>
                            ...
                            <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 hover:bg-blue-50 transition border-b">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900">{{ __('messages.system_admin') }}</div>
                                    <p class="text-xs text-gray-500">{{ __('messages.manage_entire_system') }}</p>
                                </div>
                            </a>
                            @endif
                            <a href="{{ route('group-admin.dashboard') }}" class="flex items-center px-4 py-3 bg-indigo-50 border-b">
                                ...
                                <div class="flex-1">
                                    <div class="font-semibold text-indigo-600">{{ __('messages.group_admin') }}</div>
                                    <p class="text-xs text-gray-500">{{ __('messages.currently_active') }}</p>
                                </div>
                            ...
                            <a href="{{ route('member.dashboard') }}" class="flex items-center px-4 py-3 hover:bg-purple-50 transition">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900">{{ __('messages.member') }}</div>
                                    <p class="text-xs text-gray-500">{{ __('messages.view_your_account') }}</p>
                                </div>
                            </a>
                            @endif
                        </div>
        ...
        <div id="mobileMenu" class="hidden lg:hidden border-t border-gray-200 bg-white">
            <div class="px-4 py-3 space-y-1">
                <a href="{{ route('group-admin.dashboard') }}" class="block px-4 py-2 rounded-lg text-indigo-600 bg-indigo-50 font-medium">{{ __('messages.dashboard') }}</a>
                <a href="{{ route('group-admin.members', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.members') }}</a>
                <a href="{{ route('group-admin.loans', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.loans') }}</a>
                <a href="{{ route('group-admin.savings', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.savings') }}</a>
                <a href="{{ route('group-admin.social-supports', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.social_support') }}</a>
                <a href="{{ route('group-admin.transactions', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.transactions') }}</a>
                <a href="{{ route('group-admin.reports', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.reports') }}</a>
                <a href="{{ route('group-admin.penalties', $group) }}" class="block px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">{{ __('messages.penalties') }}</a>
            </div>
        </div>
    </nav>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center space-x-3 mb-2">
                        <span class="px-3 py-1 bg-white/20 backdrop-blur rounded-full text-xs font-semibold text-white">
                            {{ $group->status === 'active' ? '🟢 ' . __('messages.active') : '⚪ ' . ucfirst($group->status) }}
                        </span>
                        <span class="px-3 py-1 bg-white/20 backdrop-blur rounded-full text-xs font-semibold text-white">
                            📅 {{ ($group->meeting_frequency ?? 'monthly') === 'weekly' ? __('messages.every_week') : __('messages.every_month') }}
                        </span>
                    ...
                    <p class="text-indigo-200 max-w-xl">{{ __('messages.manage_finances') }}</p>
                </div>
                ...
                <div class="flex flex-wrap gap-3">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/20">
                        ...
                        <div class="text-xs text-indigo-200">{{ __('messages.members') }}</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/20">
                        <div class="text-2xl font-bold text-white">{{ $stats['active_loans'] }}</div>
                        <div class="text-xs text-indigo-200">{{ __('messages.active_loans') }}</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/20">
                        <div class="text-2xl font-bold text-white">{{ number_format($stats['support_fund_available']/1000, 0) }}K</div>
                        <div class="text-xs text-indigo-200">{{ __('messages.support_fund') }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 bg-gradient-to-r from-red-500 to-rose-500 rounded-2xl p-1">
            <div class="bg-white rounded-xl p-4 flex items-center">
                ...
                <div class="flex-1">
                    <h3 class="font-bold text-red-900">⚠️ {{ $overdue_loans->count() }} {{ __('messages.overdue_loans_need_action') }}</h3>
                    <p class="text-red-700 text-sm">{{ __('messages.take_action_immediately') }}</p>
                </div>
                <a href="{{ route('group-admin.loans', $group) }}?status=overdue" class="px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition">{{ __('messages.view_now') }}</a>
            </div>
        </div>
        @endif
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-5 border border-gray-100 group hover:-translate-y-1">
                ...
                <p class="text-xs text-gray-500 font-medium">{{ __('messages.total_members') }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-5 border border-gray-100 group hover:-translate-y-1">
                ...
                <p class="text-xs text-gray-500 font-medium">{{ __('messages.active_loans') }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-5 border border-gray-100 group hover:-translate-y-1">
                ...
                <p class="text-xs text-gray-500 font-medium">{{ __('messages.total_loans_disbursed') }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-5 border border-gray-100 group hover:-translate-y-1">
                ...
                <p class="text-xs text-gray-500 font-medium">{{ __('messages.member_shares') }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-5 border border-gray-100 group hover:-translate-y-1">
                ...
                <p class="text-xs text-gray-500 font-medium">{{ ($periodStats['frequency'] ?? 'monthly') === 'weekly' ? __('messages.this_week') : __('messages.this_month') }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-5 border border-gray-100 group hover:-translate-y-1 {{ $stats['overdue_loans'] > 0 ? 'ring-2 ring-red-200' : '' }}">
                ...
                <p class="text-xs text-gray-500 font-medium">{{ __('messages.overdue') }}</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-gradient-to-br from-red-500 to-rose-600 rounded-2xl p-5 text-white">
                <p class="text-red-100 text-xs font-medium mb-1">{{ __('messages.total_penalties') }}</p>
            ...
            <div class="bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl p-5 text-white">
                <p class="text-orange-100 text-xs font-medium mb-1">{{ __('messages.total_interest') }}</p>
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl p-5 text-white">
                <p class="text-emerald-100 text-xs font-medium mb-1">{{ __('messages.support_fund') }}</p>
            ...
            <div class="bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl p-5 text-white">
                <p class="text-pink-100 text-xs font-medium mb-1">{{ __('messages.support_disbursed') }}</p>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <div>
                    <h3 class="text-lg font-bold text-gray-900 flex items-center">
                        ...
                        {{ __('messages.period_summary') }} - {{ ($periodStats['frequency'] ?? 'monthly') === 'weekly' ? __('messages.this_week') : __('messages.this_month') }}
                    </h3>
                    <p class="text-sm text-gray-500">{{ $periodStats['start'] }} - {{ $periodStats['end'] }} ({{ ($periodStats['frequency'] ?? 'monthly') === 'weekly' ? __('messages.weekly') : __('messages.monthly') }})</p>
                </div>
                <span class="mt-2 sm:mt-0 px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-xs font-semibold">
                    📅 {{ ($periodStats['frequency'] ?? 'monthly') === 'weekly' ? __('messages.every_week') : __('messages.every_month') }}
                </span>
            </div>
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div class="bg-white rounded-xl p-4 shadow-sm">
                    <p class="text-xs text-gray-500 font-medium mb-1">{{ __('messages.period_savings') }}</p>
                    <p class="text-xl font-bold text-indigo-600">{{ number_format($periodStats['savings'], 0) }}</p>
                </div>
                <div class="bg-white rounded-xl p-4 shadow-sm">
                    <p class="text-xs text-gray-500 font-medium mb-1">{{ __('messages.loans_issued') }}</p>
                    <p class="text-xl font-bold text-purple-600">{{ $periodStats['loans_issued'] }}</p>
                </div>
                <div class="bg-white rounded-xl p-4 shadow-sm">
                    <p class="text-xs text-gray-500 font-medium mb-1">{{ __('messages.contributions') }}</p>
                    <p class="text-xl font-bold text-green-600">{{ number_format($periodStats['contributions'], 0) }}</p>
                </div>
                <div class="bg-white rounded-xl p-4 shadow-sm">
                    <p class="text-xs text-gray-500 font-medium mb-1">{{ __('messages.disbursements') }}</p>
        ...
        <!-- Member Shares, Daily Savings, Monthly Savings Cards -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-yellow-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.total_loans_disbursed') }}</p>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-purple-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.member_shares') }}</p>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-cyan-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.daily_savings') }}</p>
                <div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-indigo-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.monthly_savings') }}</p>
                <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-red-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.total_penalties') }}</p>
                <div>
                    <p class="text-xl font-bold text-red-600">{{ number_format($stats['total_penalties'], 2) }}</p>
                    <p class="text-xs text-gray-500">{{ __('messages.active') }}</p>
                </div>
            </div>

            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-orange-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.total_interest') }}</p>
                <div>
                    <p class="text-xl font-bold text-orange-600">{{ number_format($stats['total_interests'], 2) }}</p>
                    <p class="text-xs text-gray-500">{{ __('messages.on_loans') }}</p>
                </div>
            </div>

            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-pink-500 flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.support_available') }}</p>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 {{ $stats['overdue_loans'] > 0 ? 'border-red-600' : 'border-green-500' }} flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.support_disbursed') }}</p>
                <div>
                    ...
                    <p class="text-xs text-gray-500">{{ __('messages.from_fund') }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 {{ $stats['overdue_loans'] > 0 ? 'border-red-500' : 'border-gray-300' }} flex flex-col justify-between h-32">
                <p class="text-gray-500 text-xs font-semibold uppercase tracking-wider">{{ __('messages.overdue_loans') }}</p>
        ...
        @if($overdue_loans->count() > 0)
            <div class="bg-red-50 border-l-4 border-red-500 rounded-lg p-6 mb-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-lg font-bold text-red-900">⚠️ {{ __('messages.overdue_loans_alert') }}</h3>
                        <p class="text-red-700 mt-2">{{ __('messages.overdue_loans_need_action') }} ({{ $overdue_loans->count() }}). {{ __('messages.take_action_immediately') }}</p>
                    </div>
                </div>
            </div>
        @endif
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-bold text-gray-900">📅 {{ __('messages.upcoming_loan_deadlines') }}</h2>
                            <p class="text-sm text-gray-600 mt-1">{{ __('messages.within_next_30_days') }}</p>
                        </div>
                        <a href="{{ route('group-admin.loans', $group) }}" class="text-blue-500 hover:text-blue-700 font-semibold text-sm">{{ __('messages.view_all') }}</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-blue-600 text-white">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.member') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.amount') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.due_date') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.days_left') }}</th>
                                </tr>
                            </thead>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                            ✓ {{ __('messages.no_loans_due_30_days') }}
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                @if($overdue_loans->count() > 0)
                    <div class="bg-white rounded-lg shadow-sm border-l-4 border-red-500">
                        <div class="border-b border-gray-200 px-6 py-4">
                            <h2 class="text-xl font-bold text-red-900">⚠️ {{ __('messages.overdue_loans') }}</h2>
                            <p class="text-sm text-red-700 mt-1">{{ __('messages.loans_past_due_date') }}</p>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                <thead class="bg-red-600 text-white">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.member') }}</th>
                                        <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.amount') }}</th>
                                        <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.was_due') }}</th>
                                        <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.days_overdue') }}</th>
                                        <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.remaining') }}</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y">
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                        <h2 class="text-xl font-bold text-gray-900">👥 {{ __('messages.members_list') }}</h2>
                        <div class="flex gap-3">
                            <a href="{{ route('group-admin.record-member-loan', $group) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold text-sm rounded-lg transition">+ {{ __('messages.record_loan') }}</a>
                            <a href="{{ route('group-admin.record-savings', $group) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-semibold text-sm rounded-lg transition">+ {{ __('messages.record_savings') }}</a>
                            <a href="{{ route('group-admin.members', $group) }}" class="text-blue-500 hover:text-blue-700 font-semibold text-sm">{{ __('messages.view_all') }}</a>
                        </div>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead class="bg-blue-600 text-white">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.name') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.role') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.active_loans') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.loan_amount') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.savings') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">{{ __('messages.status') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y">
                                    ...
                                    <tr class="{{ $detail['has_overdue'] ? 'bg-red-50' : 'hover:bg-gray-50' }} transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($detail['has_overdue'])
                                                <span class="px-2 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-800">⚠️ {{ __('messages.overdue') }}</span>
                                            @elseif($detail['upcoming_deadline'])
                                                ...
                                                <span class="px-2 py-1 rounded-full text-xs font-semibold {{ $daysUntil <= 7 ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800' }}">
                                                    {{ $daysUntil }} {{ __('messages.days') }}
                                                </span>
                                            @else
                                                <span class="text-gray-500 text-xs">{{ __('messages.good') }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
                ...
                <div class="bg-white rounded-lg shadow-sm mt-6">
                    <div class="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-bold text-gray-900">❤️ {{ __('messages.social_support_fund') }}</h2>
                            <p class="text-sm text-gray-600 mt-1">{{ __('messages.fund_balance_contributions_disbursements') }}</p>
                        </div>
                        <a href="{{ route('group-admin.social-supports', $group) }}" class="text-pink-500 hover:text-pink-700 font-semibold text-sm">{{ __('messages.view_all') }}</a>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg p-4 text-white">
                                <p class="text-xs font-medium text-emerald-100 mb-1">{{ __('messages.fund_balance') }}</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-4">
                                <p class="text-xs font-medium text-gray-500 mb-1">{{ __('messages.total_contributions') }}</p>
                                <p class="text-xl font-bold text-blue-600">{{ number_format($socialSupportStats['total_contributions'], 0) }}</p>
                            </div>
                            <div class="bg-white border border-gray-200 rounded-lg p-4">
                                <p class="text-xs font-medium text-gray-500 mb-1">{{ __('messages.total_disbursed') }}</p>
                                <p class="text-xl font-bold text-red-600">{{ number_format($socialSupportStats['total_disbursed'], 0) }}</p>
                            </div>
                            <div class="bg-white border border-gray-200 rounded-lg p-4">
                                <p class="text-xs font-medium text-gray-500 mb-1">{{ __('messages.pending_requests') }}</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                <h4 class="font-semibold text-gray-900 mb-3">📅 {{ __('messages.this_month') }}</h4>
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">{{ __('messages.contributions') }}</span>
                                        <span class="font-semibold text-green-600">+{{ number_format($socialSupportStats['contributions_this_month'], 0) }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">{{ __('messages.disbursements') }}</span>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                <h4 class="font-semibold text-gray-900 mb-3">📊 {{ __('messages.by_type_disbursed') }}</h4>
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600">☠️ {{ __('messages.death') }}</span>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600">💍 {{ __('messages.marriage') }}</span>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600">🏥 {{ __('messages.sickness') }}</span>
                        ...
                        <div class="mt-6">
                            <h4 class="font-semibold text-gray-900 mb-3">📈 {{ __('messages.12_month_history') }}</h4>
                            <div class="overflow-x-auto">
                                <table class="w-full text-xs">
                                    <thead>
                                        <tr class="bg-gray-100">
                                            <th class="px-2 py-2 text-left font-semibold text-gray-600">{{ __('messages.month') }}</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="px-2 py-2 text-green-600 font-medium">{{ __('messages.in') }}</td>
                                            @foreach($socialSupportHistory as $month)
                                        ...
                                        <tr>
                                            <td class="px-2 py-2 text-red-600 font-medium">{{ __('messages.out') }}</td>
                                            @foreach($socialSupportHistory as $month)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-3">
                                    <h4 class="font-semibold text-gray-900">{{ __('messages.recent_contributions') }}</h4>
                                    <a href="{{ route('group-admin.social-support-contributions', $group) }}" class="text-xs text-emerald-600 hover:text-emerald-800">{{ __('messages.view_all') }} →</a>
                                </div>
                                ...
                                @else
                                <p class="text-gray-500 text-sm text-center py-4">{{ __('messages.no_contributions_yet') }}</p>
                                @endif
                            </div>
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-3">
                                    <h4 class="font-semibold text-gray-900">{{ __('messages.recent_requests') }}</h4>
                                    <a href="{{ route('group-admin.social-supports', $group) }}" class="text-xs text-pink-600 hover:text-pink-800">{{ __('messages.view_all') }} →</a>
                                </div>
                                ...
                                @else
                                <p class="text-gray-500 text-sm text-center py-4">{{ __('messages.no_requests_yet') }}</p>
                                @endif
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border-t-4 border-indigo-500">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('group-admin.loan-requests', $group->id) }}" class="block px-4 py-3 bg-yellow-50 hover:bg-yellow-100 rounded-lg text-yellow-600 font-medium transition text-sm">
                            ✉️ {{ __('messages.loan_requests_pending') }}
                        </a>
                        ...
                        <a href="{{ route('group-admin.penalties', $group) }}" class="block px-4 py-3 bg-red-50 hover:bg-red-100 rounded-lg text-red-600 font-medium transition text-sm">
                            ⚖️ {{ __('messages.manage_penalties') }}
                        </a>
                        <a href="{{ route('group-admin.social-supports', $group) }}" class="block px-4 py-3 bg-pink-50 hover:bg-pink-100 rounded-lg text-pink-600 font-medium transition text-sm">
                            ❤️ {{ __('messages.manage_social_support') }}
                        </a>
                        ...
                        <a href="{{ route('admin.groups.edit', $group) }}" class="block px-4 py-3 bg-orange-50 hover:bg-orange-100 rounded-lg text-orange-600 font-medium transition text-sm">
                            ⚙️ {{ __('messages.edit_group_settings') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border-t-4 border-orange-500">
                    <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                        ...
                        {{ __('messages.record_transactions') }}
                    </h3>
                    <div class="space-y-2">
                        <a href="{{ route('group-admin.record-member-loan', $group) }}" class="block px-4 py-3 bg-blue-50 hover:bg-blue-100 rounded-lg text-blue-600 font-medium transition text-sm flex items-center">
                            ...
                            💳 {{ __('messages.record_member_loan') }}
                        </a>
                        ...
                        <a href="{{ route('group-admin.record-interest', $group) }}" class="block px-4 py-3 bg-red-50 hover:bg-red-100 rounded-lg text-red-600 font-medium transition text-sm flex items-center">
                            ...
                            📈 {{ __('messages.record_loan_interest') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border-t-4 border-pink-500">
                    <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                        ...
                        {{ __('messages.social_support_actions') }}
                    </h3>
                    <div class="space-y-2">
                        ...
                        <button onclick="showCreateSocialSupportModal()" class="w-full px-4 py-3 bg-purple-50 hover:bg-purple-100 rounded-lg text-purple-600 font-medium transition text-sm flex items-center">
                            ...
                            ➕ {{ __('messages.new_support_request') }}
                        </button>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-4">{{ __('messages.recent_savings') }}</h3>
                    <div class="space-y-3 max-h-80 overflow-y-auto">
                        @forelse($recent_savings as $saving)
                            <div class="border-l-4 border-green-500 pl-3 py-2">
                                <p class="font-semibold text-gray-900 text-sm">{{ $saving->member->user->name }}</p>
                                <p class="text-xs text-gray-600">{{ __('messages.balance') }}: {{ number_format($saving->current_balance, 2) }}</p>
                                <p class="text-xs text-gray-500 mt-0.5">{{ $saving->updated_at->diffForHumans() }}</p>
                            </div>
                        @empty
                            <p class="text-gray-500 text-center py-4 text-sm">{{ __('messages.no_savings_recorded_yet') }}</p>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-bold text-gray-900">{{ __('messages.group_information') }}</h3>
                    ...
                    <div class="space-y-3 text-sm">
                        <div>
                            <p class="text-xs text-gray-500 uppercase font-semibold">{{ __('messages.name') }}</p>
                            <p class="font-semibold text-gray-900 mt-1">{{ $group->name }}</p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 uppercase font-semibold">{{ __('messages.status') }}</p>
                        ...
                        <div>
                            <p class="text-xs text-gray-500 uppercase font-semibold">{{ __('messages.created') }}</p>
                            <p class="text-gray-600 mt-1">{{ $group->created_at->format('M d, Y') }}</p>
                        </div>
                        @if($group->description)
                        <div>
                            <p class="text-xs text-gray-500 uppercase font-semibold">{{ __('messages.description') }}</p>
...
<div id="quickCreateSocialSupportModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-screen overflow-y-auto">
        <div class="bg-pink-600 text-white p-6">
            <h2 class="text-xl font-bold">{{ __('messages.new_support_request') }}</h2>
        </div>
        <form method="POST" action="{{ route('group-admin.social-supports.store', $group) }}" class="p-6 space-y-4">
            @csrf
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.member') }} *</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.support_type') }} *</label>
                <select name="type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent">
                    ...
                    <option value="death">☠️ {{ __('messages.death_of_loved_one') }}</option>
                    <option value="marriage">💍 {{ __('messages.marriage') }}</option>
                    <option value="sickness">🏥 {{ __('messages.sickness_medical') }}</option>
                </select>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.amount') }} *</label>
                <input
                    type="number"
                    name="amount"
                    step="0.01"
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                    rows="3"
                    placeholder="{{ __('messages.provide_description') }}"
                ></textarea>
            </div>
